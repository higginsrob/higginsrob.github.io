...
const PersonalProjects: React.FC = () => {
  ...
  const handleImageClick = (project: PersonalProject) => {
    // Check if it's the Audio Separator project by ID to ensure it always opens in lightbox
    if (project.id === 'audio-separator' && project.videoUrl) {
  ...
  const projects: PersonalProject[] = [
    {
      id: 'texts-with-machine',
      title: 'Texts with the Machine',
      description: 'A static site generator and interface for displaying AI chat logs. Features a modern chat client UI, searchable sessions, agent personality cards, and light/dark mode theming.',
      technologies: ['Astro', 'React', 'Tailwind CSS', 'TypeScript'],
      githubUrl: 'https://github.com/context-assistant/texts-with-the-machine',
      liveUrl: 'https://context-assistant.github.io/texts-with-the-machine/',
      image: 'texts-with-machine.jpg',
      featured: true,
    },
    {
      id: 'htdemucs',
      title: 'HTDemucs - AI Audio Separator',
      description: 'AI-powered audio source separation tool using Hybrid Transformer Demucs. Split music tracks into separate stems (vocals, drums, bass, instruments) with a simple web interface or Docker command.',
      technologies: ['Python', 'AI/ML', 'Docker', 'Web Interface'],
      githubUrl: 'https://github.com/higginsrob/htdemucs',
      liveUrl: 'https://higginsrob.github.io/htdemucs/',
      image: 'htdemucs.jpg',
      featured: false,
    },
    {
    ...
    {
      id: 'three-js-personal',
      title: 'three.js (Enhanced Editor)',
      description: 'Personal fork of three.js featuring an enhanced editor with runtime settings, remote GLB support, and URL persistence for sharing scenes.',
      technologies: ['JavaScript', 'WebGL', 'Three.js'],
      githubUrl: 'https://github.com/higginsrob/three.js',
      liveUrl: 'https://higginsrob.github.io/three.js/',
      image: 'remote-glb.jpg',
      featured: false,
    },
    {
      id: 'three-js-ai',
      title: 'three.js (AI Enhanced)',
      description: 'A fork of the popular three.js 3D library enhanced with local AI assistance capabilities. Features an intelligent learning assistant that helps you learn three.js with full context of the documentation and your scene.',
      technologies: ['JavaScript', 'WebGL', 'AI', 'Ollama'],
      githubUrl: 'https://github.com/context-assistant/three.js',
      liveUrl: 'https://context-assistant.github.io/three.js/#',
      image: './context-three.jpg',
      featured: false,
    },
    {
      id: 'rc-10remote',
