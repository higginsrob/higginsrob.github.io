  ...
  return (
    <section id="skills" className="section-padding bg-white dark:bg-secondary-900">
      <div className="container-custom">
        ...
        {/* Skills by Category - 5 Column Layout */}
        <div className="flex flex-wrap justify-center gap-4">
          {skillCategories.map((category) => {
            ...
            return (
              <div key={category.key} className="bg-secondary-50 dark:bg-secondary-800 rounded-lg overflow-hidden w-full sm:w-[calc(50%-0.5rem)] md:w-[calc(33.333%-0.667rem)] lg:w-[calc(25%-0.75rem)] xl:w-[calc(20%-0.8rem)] min-w-[200px]">
                {/* Category Header */}
